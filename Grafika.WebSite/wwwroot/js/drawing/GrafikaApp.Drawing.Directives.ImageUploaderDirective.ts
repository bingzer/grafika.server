    ...
    export module Drawing {
        export module Directives {
            ...
            export class ImageUploadOptions {
                ...
                actualWidth: number;
                actualHeight: number;
                onUpload: (data: Models.IImageData | any) => ng.IPromise<any>;
                onClosed: () => void;
            }
                ...
                link = (scope: ng.IScope, elem: ng.IAugmentedJQuery, attrs: ng.IAttributes, ctr: any) => {
                    elem.bind('click', (evt) => {
                        ...
                        this.appCommon.$mdDialog.show({
                            ...
                            templateUrl: '/js/drawing/GrafikaApp.Drawing.Directives.ImageUploaderDirective.html',
                ...
                vm.preview = (evt) => {
                    ...
                    fileReader.onload = () => {
                        ...
                        img.onload = () => {
                            ...
                            let data = new Models.ImageData(file.name, file.size, file.type, () => getCanvasBlob());
                            vm.upload(data);
                        };
                        if (!img.src) {
