    ...
    function ImageUploaderController(scope, appCommon, uploadOptions) {
        ...
        vm.upload = function (imageData) {
            ...
            return uploadOptions.onUpload({ $imageData: imageData })
                .then(function () { return vm.message = 'Successfully uploaded'; })["catch"](function (err) { return vm.message = 'Unable to upload. ' + appCommon.formatErrorMessage(err); })["finally"](function () { return vm.uploading = false; });
        };
        vm.close = function () {
