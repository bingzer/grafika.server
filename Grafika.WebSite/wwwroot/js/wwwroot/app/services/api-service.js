...
(function (GrafikaApp) {
    var ApiService = (function (_super) {
        ...
        ApiService.prototype.get = function (path) {
            var _this = this;
            return this.$http.get(this.url(path))["catch"](function (reason) { return _this.log(reason); });
        };
        ApiService.prototype.post = function (path, data) {
            var _this = this;
            return this.$http.post(this.url(path), data)["catch"](function (reason) { return _this.log(reason); });
        };
        ApiService.prototype.put = function (path, data) {
            var _this = this;
            return this.$http.put(this.url(path), data)["catch"](function (reason) { return _this.log(reason); });
        };
        ApiService.prototype["delete"] = function (path) {
            var _this = this;
            return this.$http["delete"](this.url(path))["catch"](function (reason) { return _this.log(reason); });
        };
