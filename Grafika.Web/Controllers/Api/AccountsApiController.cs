...
namespace Grafika.Web.Controllers
{
    ...
    [Route("api/accounts")]
    public partial class AccountsApiController : Controller
    {
        private readonly IAccountService _accountService;
        private readonly GoogleOAuthProviderConfiguration _googleOAuthConfig;

        public AccountsApiController(IAccountService accountService, IOptions<GoogleOAuthProviderConfiguration> options)
        {
